...
const About = () => {
  return (
    <section id='about' className='bg-danger text-center p-5'>                  
          <p className='bg-danger fw-bold fs-2 text-dark'>
            About Me
          </p>
