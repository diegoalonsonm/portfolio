...
export const Hero = () => {
  return (
    <section className='container-fluid text-center p-lg-40 bg-light'>
        ...
        <p className="h2 text-info fw-semibold bg-light">Web Developer</p>
        <ButtonComponent className="mx-1 mt-3 hero-btn" color="primary" textColor="white" text="Contact Me" href="contact" />
