...
const AWSIcon = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-brand-aws" width="44" height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="#094067" fill="none" stroke-linecap="round" stroke-linejoin="round">
